...
import img2 from './../../assets/img/IMG-20220108-WA0010 Low v1.jpg';
import img2High from './../../assets/img/IMG-20220108-WA0010High.jpg';

export default class OnBoardingItemTwo extends Component {
    render() {
        return (
             <article className ="OnBoardingItemTwo">
                    <div className = "Stack">
